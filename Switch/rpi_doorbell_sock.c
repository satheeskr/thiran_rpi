/*=============================================
Name: rpi_doorbell_sock.c
Author: Sathees Balya
Description:
This file receives the doorbell button press
and activates remote socket and the bell.
==============================================*/
#include "stdio.h"
#include "stdlib.h"
#include "sys/mman.h"
...
{
	/* Switch 1 on */
	bytecode_sock = "000000010100010001010101"; /* 0x014455 */
}
else
{
	/* Switch 1 off */
	bytecode_sock = "000000010100010001010100"; /* 0x014454 */		
}

bytecode_bell = "011100000100"; /* 0x704 */
...
/* Make port as input before exiting */
INPORT(PORT_NUM);
}
