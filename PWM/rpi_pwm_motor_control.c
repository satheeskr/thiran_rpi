...
Description:
This file measures temperature from a sensor and
drives a motor according to the temperature. It 
...
#include "unistd.h"
#include "pthread.h"
#include "rpi_pwm_motor_control.h"
#include "math.h"

#define NUM_THREADS 3u
...
void * motor_control(void * arg)
{	
/* Configure GPIO18 as PWM1 output (ALT 5) to control a motor */
INPORT(18u);
PORT_CONFIG(18u, 2u);
