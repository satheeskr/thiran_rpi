...
var LightController = {
  name: "Bedroom2 Light", //name of accessory
  pincode: "031-45-154",
  username: "FB:3C:ED:5A:1A:1A", // MAC like address used by HomeKit to differentiate accessories. 
  ...
  setPower: function(status) { //set power of accessory
    ...
    var exec = require('child_process').exec, child;
        if(status){
        child = exec('sleep 1; sudo /var/www/html/rf/nexa 3; sleep 1');
	}
	else
	{
        child = exec('sleep 1; sudo /var/www/html/rf/nexa 4; sleep 1');
	}
  },
