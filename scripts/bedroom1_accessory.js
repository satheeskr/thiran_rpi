...
var LightController = {
  name: "Bedroom1 Light", //name of accessory
  pincode: "031-45-154",
  username: "FC:3C:ED:5A:1A:1A", // MAC like address used by HomeKit to differentiate accessories. 
  ...
  setPower: function(status) { //set power of accessory
    ...
    var exec = require('child_process').exec, child;
        if(status){
        child = exec('sudo /var/www/html/rf/nexa 5');
	}
	else
	{
        child = exec('sudo /var/www/html/rf/nexa 6');
	}
  },
